...
EACO 是 Solana 链上的社区 MEME + 实用型代币，总量 13.5 亿枚（致敬地球）。围绕 $e 构建了 **Agent World、VPN 网络、DAO 治理、跨境支付、AI Agent 经济** 五大生态，海外网友有多种赚钱路径：
...
| [**side-income-01-content-digital.md**](./side-income-01-content-digital.md) | 🌟 **1000个副业变现·内容与数字产品篇（方法1-300）** |
| [**side-income-02-ecommerce-freelance.md**](./side-income-02-ecommerce-freelance.md) | 🌟 **1000个副业变现·电商与自由职业篇（方法301-600）** |
| [**docs/side-income-eaco-ecnh.md**](./docs/side-income-eaco-ecnh.md) | 🌟 **1000种副业·EACO+eCNH专项版（Part-A×100 + Part-B×100 + 索引）** |

### 🧭 副业变现速查

> **1000个副业变现 × EACO生态联动**，每个方法标注：门槛🆓💰💎 / 变现路径 / 联动$e程度

| 类别 | 方法数 | 门槛 | 与$e联动 |
|------|--------|------|---------|
| 内容创作类（写作/视频/音频） | 150 | 🆓 | 中 |
| 数字产品类（软件/模板/课程） | 150 | 🆓 | 中 |
| 电商零售类（Dropshipping/实物） | 150 | 💰 | 低 |
| 自由职业类（设计/技术/服务） | 150 | 🆓 | 中 |
| 知识付费类（课程/社群/咨询） | 150 | 🆓 | 低 |
| Web3/区块链类（DeFi/NFT/DAO） | 150 | 🆓/💰 | **极高** |
| 资产与被动收益类 | 100 | 💎 | 低 |
| **合计** | **1000** | — | — |
...
| 文件 | 说明 |
|------|------|
| [docs/side-income-eaco-ecnh.md](./docs/side-income-eaco-ecnh.md) | 🌟 EACO激励系(×100)+eCNH收款系(×100)副业专项 |
...
| 类型 | 链接 |
|------|------|
| 购买 $e (Orca) | https://www.orca.so |
| 购买 $e (Raydium) | https://raydium.io |
